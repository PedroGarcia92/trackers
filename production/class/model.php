...
class model
{
	...
	protected function datos($p){
		...
		//$p["Estimacion"]
		 ...
		 $query.=",`DomicilioDeCarga`,`CitaDeCarga`,`DomicilioDescarga`,`CitaDescarga`)";
		 ...
		 $query.="','".date('Y-m-d H:i:s',strtotime($p["CitaDeCarga"]))."','".$p["DomicilioDescarga"]."','".date('Y-m-d H:i:s',strtotime($p["CitaDescarga"]))."');";
