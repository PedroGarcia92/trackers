                    ...
                    <div id="wizard" class="form_wizard wizard_horizontal">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6 col-sm-6 ">
                            <!-- <input id="CitaDeCarga" class="form-control col" type="text" name="CitaDeCarga" placeholder=""> -->
                             <div class="input-group date form_datetimeCitaDecarga col-sm-8 col-md-8" data-date="" data-date-format="mm/dd/yyyy  h:ii P" data-link-field="dtp_input1">
                             <input class="form-control" size="8" type="text" id="CitaDeCarga" name="CitaDeCarga" readonly>
                      ...
                      <div id="step-4" style="height:290px;">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group date form_datetimeCitaDescarga col-sm-8 col-md-8" data-date="" data-date-format="mm/dd/yyyy  h:ii P" data-link-field="dtp_input1">
                          <input class="form-control" size="16" type="text" id="CitaDescarga" name="CitaDescarga" readonly>
                          <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                          <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                          </div>
                      ...
                      <div id="step-5">
                        <div class="form-group row">
                          ...
                          <div class="col-md-6 col-sm-6 ">
                            <button type="input" class="btn btn-success btn-sm" onclick="Obcon.interactActivoCerrado('Activo')" id='idActivo'>Activo</button>
                            <button type="input" class="btn btn-primary btn-sm"onclick="Obcon.interactActivoCerrado('Cerrado')" id='idCerrado'>Cerrado</button>
                        </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-form-label col-md-3 col-sm-3 label-align">Facturado</label>
                          <div class="col-md-6 col-sm-6 ">
                            <button type="input" class="btn btn-success btn-sm" onclick="Obcon.interactFactura('Si');" id="siFacturado">Si</button>
                            <button type="input" class="btn btn-primary btn-sm" id="noFacturado"
                            onclick="Obcon.interactFactura('No');">No</button>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                        <select class="form-control select2" style="width: 100%;" name="ReporteTms" id="ReporteTms">
                          <?php
                          for ($tms=1; $tms <= 5 ; $tms++) {
                            if ($tms==1) {
                              $seltms="selected";
